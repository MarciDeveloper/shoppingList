        ...
        <ul class="list-group">
                    <?php
                        ...
                        foreach($result as $row): 
                            ...
                            $edit='';} else {
                            $edit =  "<p><a id='edit' href = 'editItems.php?itemName=$itemName&itemDescription=$itemDescription&itemPrice=$itemPrice&itemID=" . $row['itemID'] . "'><i class='far fa-edit'></i> </a> <span> | </span>  <a href= '../controller/itemDelete.php?itemID=$itemID' ><i class='fas fa-trash-alt'></i></a></p>"; }                  
